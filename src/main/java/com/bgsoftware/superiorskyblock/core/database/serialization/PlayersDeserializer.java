...
public class PlayersDeserializer {
    ...
    public static void deserializeMissions(DatabaseBridge databaseBridge, @Nullable DatabaseFilter filter, DatabaseCache<SuperiorPlayer.Builder> databaseCache) {
        databaseBridge.loadObject("players_missions", filter, missionsRow -> {
            DatabaseResult missions = new DatabaseResult(missionsRow);
    ...
    public static void deserializePlayerSettings(DatabaseBridge databaseBridge, @Nullable DatabaseFilter filter, DatabaseCache<SuperiorPlayer.Builder> databaseCache) {
        databaseBridge.loadObject("players_settings", filter, playerSettingsRow -> {
            DatabaseResult playerSettings = new DatabaseResult(playerSettingsRow);
    ...
    public static void deserializePersistentDataContainer(DatabaseBridge databaseBridge, @Nullable DatabaseFilter filter, DatabaseCache<SuperiorPlayer.Builder> databaseCache) {
        databaseBridge.loadObject("players_custom_data", filter, customDataRow -> {
            DatabaseResult customData = new DatabaseResult(customDataRow);
